...
import com.syntaxsolutions.azkarcalculator.view.activityInteractor.QathmCreationInteractor;
import com.syntaxsolutions.azkarcalculator.view.fragment.DatePickerFragment;

/**
 * Created by suhail.kk on 18-11-2016.
 */
public class QathmCreationActivity extends AppCompatActivity {
    EditText edtName, edtStartDate, edtEndDate, edtTarget;
    CoordinatorLayout cordinatorlayout;
    QathmCreationInteractor qathmCreationInteractor;
    ...
    protected void setToolBar() {
        ...
        getSupportActionBar().setTitle("New Qathm Creation");
    ...
    private void initView() {
        qathmCreationInteractor=new QathmCreationInteractor(getApplicationContext());
    ...
    private void proceedSave() {
        ...
        saveResponce = qathmCreationInteractor.save(name, startDate, endDate);
