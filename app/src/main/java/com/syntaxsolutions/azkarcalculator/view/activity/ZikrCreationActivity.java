...
import com.syntaxsolutions.azkarcalculator.view.activityInteractor.ZikrCreationInteractor;
import com.syntaxsolutions.azkarcalculator.view.fragment.DatePickerFragment;

/**
 * Created by suhail.kk on 30-09-2016.
 */
public class ZikrCreationActivity extends AppCompatActivity {
    EditText edtName, edtStartDate, edtEndDate, edtTarget;
    CoordinatorLayout cordinatorlayout;
    ZikrCreationInteractor zikrCreationInteractor;
    ...
    protected void setToolBar() {
        ...
        getSupportActionBar().setTitle("New Zikr Creation");
    ...
    private void initView() {
        zikrCreationInteractor = new ZikrCreationInteractor(getApplicationContext());
    ...
    private void proceedSave() {
        ...
        saveResponce = zikrCreationInteractor.save(name, startDate, endDate, target);
